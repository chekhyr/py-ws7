...
// * - API level 7.263.xx related functions are added
	...
	// WLMDATA_EXPORTS must not be defined for any project using this dll.
		...
		#define NOT_MANGLED
		typedef long *      lref;
		typedef int64_t *   l64ref;
		typedef double *    dref;
		typedef char *      sref;
		#endif
		
		#define Data_API(ret) NOT_MANGLED ret
...
// ***********  API level 7.254.xx level related functions  *************
//	Data_API(long)			GetOptionInfo(long Index, long Detail, l64ref I64Val, dref DblVal) ;				// Obsolote function signature
...
// ***********  API level 7.263.xx level related functions  *************
	Data_API(long)           GetWLMInfo(long Index, long Detail, l64ref I64Val, dref DblVal, sref SVal);
	Data_API(long)           GetDeviceInfo(long Index, long Detail, l64ref I64Val, dref DblVal, sref SVal);
	Data_API(long)           GetOptionInfo(long Index, long Detail, l64ref I64Val, dref DblVal, sref SVal);		// updated function signature
